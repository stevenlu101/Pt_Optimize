...
**结果**：给出两档全判据通过的定案构型，整线总铂重 **3547 g**（管壁 0.8 mm）与
...
> 本文其余章节的模型、闭式与方法论结论**均不受影响**，受影响的只有定案数值本身。
...
偏离定案点的算例收益最大：「管保温 1 mm」档纯 Picard 需 **734 轮／17.4 min**，
...
6. **给出两档全判据通过的定案**：3547 g（管壁 0.8）与
...
6c. **装配可行性是判据，不是事后检查。** 初版定案的舌片自由段只有 24 mm，
