...
|---|---|---|---|
| **管壁 0.8 · 留余量** | **3106 g** | $-56\ \%$ | 无 —— 每条判据都有裕度 |
| **管壁 0.6 · 底档** | **2388 g** | $-66\ \%$ | 焊接烧穿下界（余量 **0**）＋ 管 J 10.96/12（余量 9 %），**两条同点** |
...
| 舌片 | $90\times30$，等宽 | 同左 |
| 舌根圆角 | $R3$ | 同左 |
| **板厚**（入口/共用1/共用2/出口）| **2.11 / 3.33 / 3.12 / 1.76** | **1.82 / 2.85 / 2.66 / 1.49** |
| 管孔渐变环 内级倍率 | $\times1.22$ | $\times1.20$ |
| **舌保温**（四片）| **18.7 / 1.6 / 1.4 / 3.9 mm** | 同左 |
| 压接段 | 舌端往回 40 mm，夹 450 °C | 同左 |
| 管 / 法兰 / 合计 | 2466 / 641 / **3106 g** | 1842 / 547 / **2388 g** |

## 2.2 两条别改成「统一规格」的地方

**① 四片板厚不能等厚。** 共用片比端片厚 58–89 %。这是 $\sqrt3$ 倍电流经平方律放大的
