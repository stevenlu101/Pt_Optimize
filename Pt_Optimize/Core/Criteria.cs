...
public static class Criteria
{
    ...
    public static readonly Entry[] All =
    {
        ...
        E(LineResult.Key.WrapTurns, "mm",    "≤", "管–盘接合区（圆盘靠管孔的内环带）的圆盘保温厚度折成几圈；现场一圈 0.5 mm，一次缠绕缠到 20 圈以上会渐成球形。决 104（业主 2026-09-25「圆盘保温块最大厚度(圆盘之前说过了10mm)」）：上限 = 参数表「圆盘保温上限」（缺省 10 mm = 20 圈），超过即不可行、不外推、不按上限硬算；可动杠杆是舌板保温、舌半宽与锥形舌片、舌根挖孔、盘径、夹持温度。改回口径（决103前）按 2026-09-18 只作参考、不卡交付，超了提示改用预制保温块。管保温与舌板保温好缠绕，不在此列", true),
