...
**确认了但还没修（欠账，按紧要度）**：
- 熔化处置的杠杆（基板厚）够不到舌片（**高**）：探针熔在舌片上时被印成「厚度到头 ⇒ 交棒增宽」；按用户口径熔化是辅助验证、J=10 下不会熔，先记着 —— 修法：熔点在舌片就抬 `TongueThickMm`。
