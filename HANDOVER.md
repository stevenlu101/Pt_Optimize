...
| **提交钩子约 11 分钟** | 构建 + UiWiring **145 秒**（§16、§31 各一次真解，§29、§32 各起一次 Rhino）+ selfcheck 7.9 分 | 一度以为要 19 分 —— 其实是 UiWiring **挂住不退**（见 §7 那条）。修掉之后回到 11 分。再要缩只能动 selfcheck，而它是核心回归门，不该为省时间削弱 |
