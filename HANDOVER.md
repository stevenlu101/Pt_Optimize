...
| `法兰截面 J` | 11 A/mm² | **硬判据** | **用户 2026-09-08 设计因果链第 ④ 步**：设计电流（温控 20 °C/h 空管升温全程峰值，共用片矢量合成）÷ 必经截面积（舌片各处含开孔／舌盘交界弦／孔缘环与各级环含槽带，圆盘按整圈）。按 J=10 定尺寸（约束盒下角），终验全体 < 11。闭式、与网格无关 |
