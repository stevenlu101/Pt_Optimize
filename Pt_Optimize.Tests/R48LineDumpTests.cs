...
///   每个算例一份转储文件，SHA-256 取文件全文（UTF-8 无 BOM）；另算「去文字」SHA-256（文字成员只写长度），给记录门用（说明文字改措辞不该动数）。
///
...
public class R48LineDumpTests
{
    ...
    {
        ["B2_带玻璃"] = "e2c8c9dd29de26a84b8fb330ecd91ac137764999b22bdf204a6fcc29f0e3f379",
        ["B2_空管_管腔系数0"] = "31eeb735a7c5210e7e94f466a83f5795d0d3ba665a35ad3880ab4291bb4a02ba",
        ["B2_空管_默认管腔系数"] = "211797041de4668a76658f8485cc53a49a60cbbaad26d6c4d30b3471a674d9e6",
        ["B2_带玻璃_实测电流"] = "5703fc7f262167a6f1c94986d181435b522e7c82eaceea673bfc82d614e10275",
        ["盘56两段_解析_电导率随温度"] = "381aae3b954b75add615c502475f23b295b4f38bc2a4cc5260538136731a9ff2",
        ["盘56两段_图纸路径"] = "817ec7cf060b2da46883f3bb2b74f1510b43ef1180c884da2af4960ecf33abef",
    };
    ...
    public void 整线全量转储_六个算例_逐算例SHA256()
    {
        ...
        string dir = Path.Combine(root, "deliverable");
        string sumFile = Path.Combine(dir, $"R48_整线全量转储_SHA256汇总_本次开跑于{Stamp}.txt");
        ...
        foreach (var name in CaseNames)
        {
            ...
            string file = Path.Combine(dir, $"R48_整线全量转储_{name}_本次开跑于{Stamp}.txt");
    ...
    /// <summary>跑后算例 + 结果的全量转储文本（成员名排序、double 按 R）。<paramref name="withText"/> false ⇒ 文字成员只写长度。</summary>
