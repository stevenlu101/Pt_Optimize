...
public class R48LEndTempAmpGateTests
{
    ...
    private void 断言停机判定读闭式放大(bool useClosedForm)
    {
        ...
        // ★ 核心断言：判收敛量之比 = 闭式/25。把放大改回写死 25 ⇒ 比值变 1 ⇒ 这一行红。
        Assert.Equal(closed / LineCase.FixedPointAmp, it.JudgeK / itRef.JudgeK, 9);
    }
